 ...
 * @param irgen_only Pointer to a boolean flag set to true if --irgen is present.
 ...
 */
const char *parse_args(int argc, char *argv[], bool *lex_only, bool *parse_only, bool *irgen_only, bool *codegen_only);
