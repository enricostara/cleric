...
const char *parse_args(const int argc, char *argv[], bool *lex_only, bool *parse_only, bool *codegen_only) {
    *lex_only = false;
    *parse_only = false;
    *codegen_only = false;
    ...
    // Case 2: Mode-specific usage (cleric --lex <file> or cleric --parse <file> or cleric --codegen <file>)
    else if (argc == 3) {
        ...
        // If argv[1] is not --lex, --parse, or --codegen, fall through to error
    }
